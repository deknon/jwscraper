...
1. วาง URL ของหน้าเว็บที่มีวิดีโอในช่องข้อความ (หรือแชร์ลิงก์จากแอปอื่น / เปิดด้วยแอปนี้)
2. กดปุ่ม **ไป** — WebView จะโหลดหน้าเว็บ
3. ใช้ปุ่ม **←** หรือปุ่มย้อนกลับระบบเพื่อย้อน WebView
4. รอให้รายการวิดีโอที่ตรวจพบขึ้นด้านล่าง (ดู badge / Snackbar เมื่อพบรายการใหม่)
5. กรองด้วยชิป **ทั้งหมด / MP4 / HLS / อื่นๆ** แล้วเลือก URL — กด **คัดลอก** ได้
6. กดปุ่ม **ดาวน์โหลด**
...
1. อนุญาต **การแจ้งเตือน** (POST_NOTIFICATIONS)
2. เมื่อเริ่มดาวน์โหลด HLS แอปจะถามให้ปิดจำกัดแบตเตอรี่ — กดอนุญาต
3. ในตั้งค่าแอป Xiaomi: เปิด **Autostart** + ตั้ง Battery เป็น **No restrictions** / ไม่จำกัด
4. ตอน mux ยาวๆ อย่าปัดแอปออกจาก Recents
